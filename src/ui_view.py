...
# licensing of 'src/qt/view.ui' applies.
#
# Created: Thu Dec  5 15:43:33 2019
...
class Ui_View(object):
    ...
    def retranslateUi(self, View):
        View.setWindowTitle(QtWidgets.QApplication.translate("View", "Grow airway tree", None, -1))
        self.groupBox_3.setTitle(QtWidgets.QApplication.translate("View", "Airway tree input", None, -1))
        self.airwayIpnode_pushButton.setText(QtWidgets.QApplication.translate("View", ".ipnode", None, -1))
        self.airwayIpelem_pushButton.setText(QtWidgets.QApplication.translate("View", ".ipelem", None, -1))
        self.loadAirway_pushButton.setText(QtWidgets.QApplication.translate("View", "Load", None, -1))
        self.groupBox_4.setTitle(QtWidgets.QApplication.translate("View", "Surface input", None, -1))
        self.surfaceIpnode_pushButton.setText(QtWidgets.QApplication.translate("View", ".ipnode", None, -1))
        self.surfaceIpelem_pushButton.setText(QtWidgets.QApplication.translate("View", ".ipelem", None, -1))
        self.loadSurface_pushButton.setText(QtWidgets.QApplication.translate("View", "Load", None, -1))
        self.groupBox_2.setTitle(QtWidgets.QApplication.translate("View", "Generating", None, -1))
        self.label_4.setText(QtWidgets.QApplication.translate("View", "Angle min:", None, -1))
        self.label.setText(QtWidgets.QApplication.translate("View", "Grid size:", None, -1))
        self.label_2.setText(QtWidgets.QApplication.translate("View", "Start node:", None, -1))
        self.label_7.setText(QtWidgets.QApplication.translate("View", "Shortest length:", None, -1))
        self.label_3.setText(QtWidgets.QApplication.translate("View", "Angle max:", None, -1))
        self.label_5.setText(QtWidgets.QApplication.translate("View", "Branch fraction:", None, -1))
        self.label_6.setText(QtWidgets.QApplication.translate("View", "Length limit:", None, -1))
        self.label_8.setText(QtWidgets.QApplication.translate("View", "Rotation limit:", None, -1))
        self.generate_pushButton.setText(QtWidgets.QApplication.translate("View", "Generate", None, -1))
        self.reset_checkBox.setText(QtWidgets.QApplication.translate("View", "Reset airway tree", None, -1))
        self.groupBox.setTitle(QtWidgets.QApplication.translate("View", "Saving", None, -1))
        self.outputExnode_pushButton.setText(QtWidgets.QApplication.translate("View", ".exnode", None, -1))
        self.outputExelem_pushButton.setText(QtWidgets.QApplication.translate("View", ".exelem", None, -1))
        self.save_pushButton.setText(QtWidgets.QApplication.translate("View", "Save", None, -1))
        self.info_pushButton.setText(QtWidgets.QApplication.translate("View", "Info", None, -1))
